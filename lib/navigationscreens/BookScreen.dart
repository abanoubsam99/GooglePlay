...
import 'package:finalgoogleplay/navigationscreens/Widgets_items/Book_Widgets.dart';
...
class _BookScreenState extends State<BookScreen> {
  List<String> _tabs = ['For you', 'Top selling', 'Genres','Top free'];
  String title="Search Books      ";
      ...
      child: new Scaffold(
        ...
        body: new NestedScrollView(
          ...
          body: new TabBarView(
            ...
            children: <Widget>[Foryou(),Topselling(),Genres(),Topfree()],
          ),
        ),
      ),
    );
