...
import 'package:finalgoogleplay/navigationscreens/Widgets_items/Movie_Widgets.dart';
...
class _MovieScreenState extends State<MovieScreen> {
  List<String> _tabs = ['For you', 'Top selling', 'New releases','Genres','Studios'];
  String title="Search Movies & TV";
      ...
      child: new Scaffold(
        ...
        body: new NestedScrollView(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                              ...
                              child: Text(title,style: TextStyle(fontSize: 17,color: Colors.grey),)),
          ...
          body: new TabBarView(
            ...
            children: <Widget>[Foryou(),Topselling(),Newreleases(),Genres(),Studios()],
          ),
        ),
      ),
    );
