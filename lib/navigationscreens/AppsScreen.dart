...
import 'package:finalgoogleplay/navigationscreens/Widgets_items/Apps_Widgets.dart';
...
class _AppsScreenState extends State<AppsScreen> {
  List<String> _tabs = ['For you', 'Top charts','Categories','Editors\'Choice','Family','Early access'];
        ...
        body: new NestedScrollView(
          ...
          body: new TabBarView(
           physics: NeverScrollableScrollPhysics(),
            children: <Widget>[Foryou(),Topcharts(),Categories(),EditorsChoice(),Family(),Earlyaccess()],
          ),
        ),
      ),
    );
